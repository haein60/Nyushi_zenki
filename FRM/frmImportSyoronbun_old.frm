...
Begin VB.Form frmImportSyoronbun_old 
   Caption         =   "frmImportSyoronbun : 素点入力(小論文)_import"
   ClientHeight    =   8790
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   12960
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Picture         =   "frmImportSyoronbun_old.frx":0000
   ScaleHeight     =   8790
   ScaleWidth      =   12960
   WindowState     =   2  '最大化
   ...
   End
   Begin VB.Label lblCSVPathFile2 
      BackColor       =   &H00F4DBC4&
      BackStyle       =   0  '透明
   ...
   Begin VB.Label lblErrorDetails 
      ...
      Width           =   8010
   End
   Begin VB.Label lblCSVPathFile1 
      BackColor       =   &H00F4DBC4&
      BackStyle       =   0  '透明
      Caption         =   "素点入力(小論文)"
      BeginProperty Font 
   ...
   End
End
Attribute VB_Name = "frmImportSyoronbun_old"
