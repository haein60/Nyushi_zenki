...
Begin VB.Form frmChooseiScore 
   ...
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Picture         =   "frmChooseiScore.frx":0000
   ScaleHeight     =   10110
   ScaleWidth      =   13230
   WindowState     =   2  'Å‘å‰»
   ...
   Begin VSFlex7LCtl.VSFlexGrid vsfSearchGrid 
      ...
      FormatString    =   $"frmChooseiScore.frx":3AD3
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VSFlex7LCtl.VSFlexGrid vsfselectRawScore 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"frmChooseiScore.frx":3BA8
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmChooseiScore"
