...
Begin VB.Form dlgChangeZip 
   ...
   End
End
Attribute VB_Name = "dlgChangeZip"
...
Private Sub Form_Load()
    ...
    txtZipCode.Text = frmExamineeProfile.txtZipCodeId.Text
    Call f_void_FormatGridGeneral(grdArea, 5, f_str_GeneralHeader)
    Exit Sub
ErrorHandler:
    MsgBox Err.Description, vbInformation, LoadResString(1729)
    ...
    If l_int_RetVal = vbYes Then
        If Len(Trim(txtZipCode.Text)) <> 0 Then
            ...
            If Not l_obj_Rst.EOF Then
                frmExamineeProfile.txtZipAddress.Text = l_obj_Rst("vPrefectureName") & "," & l_obj_Rst("vCityName") & "," & _
        ...
        frmExamineeProfile.txtZipCodeId.Text = ""
        If txtZipCode.Text <> "" Then
            frmExamineeProfile.txtZipCodeId.Text = txtZipCode.Text
        End If
        Unload Me
        frmExamineeProfile.Show
    End If
